...
<html class="supernova"><head>
    ...
    <link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F90247793343361" title="oEmbed Form"><link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F90247793343361" title="oEmbed Form">
    <meta property="og:title" content="devis basic" >
    <meta property="og:url" content="https://form.jotformeu.com/90247793343361" >
    <meta property="og:description" content="Please click the link to complete this form.">
    <link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
    <link rel="canonical" href="https://form.jotformeu.com/90247793343361" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
    <meta name="HandheldFriendly" content="true" />
    <title>devis basic</title>
    <link href="https://cdn.jotfor.ms/static/formCss.css?3.3.9632" rel="stylesheet" type="text/css" />
    <link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.9632" />
    <link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.9632" />
    ...
    <script type="text/javascript">
        ...
        JotForm.prepareCalculationsOnTheFly([null,{"description":"","name":"nombre","qid":"1","subLabel":"","text":"idDevis","type":"control_number"},{"description":"","name":"typeA","qid":"2","subLabel":"","text":"numDevis","type":"control_textbox"},{"description":"","name":"date","qid":"3","text":"dateDevis","type":"control_datetime"},{"description":"","name":"date4","qid":"4","text":"dateFinValidite","type":"control_datetime"},{"description":"","name":"typeA5","qid":"5","subLabel":"","text":"commentaire","type":"control_textarea"},{"description":"","name":"nombre6","qid":"6","subLabel":"","text":"clientInterlocuteurId","type":"control_number"},{"description":"","name":"nombre7","qid":"7","subLabel":"","text":"typeLivraisonId","type":"control_number"},{"description":"","name":"nombre8","qid":"8","subLabel":"","text":"entrepriseContactId","type":"control_number"},{"description":"","name":"nombre9","qid":"9","subLabel":"","text":"entrepriseId","type":"control_number"},{"description":"","name":"nombre10","qid":"10","subLabel":"","text":"NofactureIdmbre","type":"control_number"},{"name":"soumettre","qid":"11","text":"Soumettre","type":"control_button"}]);
        setTimeout(function() {
            JotForm.paymentExtrasOnTheFly([null,{"description":"","name":"nombre","qid":"1","subLabel":"","text":"idDevis","type":"control_number"},{"description":"","name":"typeA","qid":"2","subLabel":"","text":"numDevis","type":"control_textbox"},{"description":"","name":"date","qid":"3","text":"dateDevis","type":"control_datetime"},{"description":"","name":"date4","qid":"4","text":"dateFinValidite","type":"control_datetime"},{"description":"","name":"typeA5","qid":"5","subLabel":"","text":"commentaire","type":"control_textarea"},{"description":"","name":"nombre6","qid":"6","subLabel":"","text":"clientInterlocuteurId","type":"control_number"},{"description":"","name":"nombre7","qid":"7","subLabel":"","text":"typeLivraisonId","type":"control_number"},{"description":"","name":"nombre8","qid":"8","subLabel":"","text":"entrepriseContactId","type":"control_number"},{"description":"","name":"nombre9","qid":"9","subLabel":"","text":"entrepriseId","type":"control_number"},{"description":"","name":"nombre10","qid":"10","subLabel":"","text":"NofactureIdmbre","type":"control_number"},{"name":"soumettre","qid":"11","text":"Soumettre","type":"control_button"}]);}, 20);
    </script>
</head>
<body>
<form class="jotform-form" action="${pageContext.request.contextPath}/devis" method="post" name="form_90247793343361" id="90247793343361" accept-charset="utf-8">
    <input type="hidden" name="formID" value="90247793343361" />
    <div class="form-all">
        <link type="text/css" rel="stylesheet" media="all" href="https://cdn.jotfor.ms/wizards/languageWizard/custom-dropdown/css/lang-dd.css?3.3.9632" />
        <div class="cont">
        ...
        <ul class="form-section page-section">
            ...
            *
            ...
            <li class="form-line" data-type="control_datetime" id="id_3">
                <label class="form-label form-label-top form-label-auto" id="label_3" for="lite_mode_3"> dateDevis </label>
              ...
              <span class="form-sub-label-container" style="vertical-align:top">
                ...
                <label class="form-sub-label" for="year_3" id="sublabel_year" style="min-height:13px"> an </label>
                        ...
                        <span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_3" size="12" data-maxlength="12" data-age="" value="" data-format="mmddyyyy" data-seperator="-" placeholder="mm-dd-yyyy" />
              <img alt="Pick a Date" id="input_3_pick" src="https://cdn.jotfor.ms/images/calendar.png" style="vertical-align:middle;margin-left:5px" data-component="datetime" />
              <label class="form-sub-label" for="lite_mode_3" id="sublabel_litemode" style="min-height:13px"> Date </label>
            </span>
                        <span class="form-sub-label-container" style="vertical-align:top">
            ...
            <li class="form-line" data-type="control_datetime" id="id_4">
                <label class="form-label form-label-top form-label-auto" id="label_4" for="lite_mode_4"> dateFinValidite </label>
              ...
              <span class="form-sub-label-container" style="vertical-align:top">
                ...
                <label class="form-sub-label" for="year_4" id="sublabel_year" style="min-height:13px"> an </label>
                        ...
                        <span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_4" size="12" data-maxlength="12" data-age="" value="" data-format="mmddyyyy" data-seperator="-" placeholder="mm-dd-yyyy" />
              <img alt="Pick a Date" id="input_4_pick" src="https://cdn.jotfor.ms/images/calendar.png" style="vertical-align:middle;margin-left:5px" data-component="datetime" />
              <label class="form-sub-label" for="lite_mode_4" id="sublabel_litemode" style="min-height:13px"> Date </label>
            </span>
                        <span class="form-sub-label-container" style="vertical-align:top">
...
<!--                <input type="number" id="input_10" name="q10_nombre10" data-type="input-number" class=" form-number-input form-textbox validate[required]" style="width:60px" size="5" value="" placeholder="ex: 23" data-component="number" required="" /> -->
    ...
    <input type="hidden" id="simple_spc" name="simple_spc" value="90247793343361" />
    <script type="text/javascript">
        document.getElementById("si" + "mple" + "_spc").value = "90247793343361-90247793343361";
    </script>
    <div class="formFooter-heightMask">
    </div>
    <div class="formFooter f6">
        <!-- <a href="https://www.jotform.com/pricing?utm_source=formfooter&utm_medium=banner&utm_term=90247793343361&utm_content=jotform_logo&utm_campaign=powered_by_jotform_le" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" src="https://cdn.jotfor.ms/assets/img/logo/logo-new@1x.png" alt="" style="height: 44px;"></a> -->
        <div class="formFooter-rightSide">
      <span class="formFooter-text">
        <!-- Now create your own JotForm - It's free! -->
      </span>
            <!-- <a class="formFooter-button" href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=90247793343361&utm_content=jotform_button&utm_campaign=powered_by_jotform_le" target="_blank">Create your own JotForm</a> -->
        </div>
    </div>
</form></body>
</html>
